 ...
 */
final class Version20211127205240 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE liste_etudiant ADD id INT AUTO_INCREMENT NOT NULL, CHANGE id_au_d id_au_d VARCHAR(15) DEFAULT NULL, CHANGE id_au_f id_au_f VARCHAR(15) DEFAULT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE liste_etudiant MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE liste_etudiant DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE liste_etudiant DROP id, CHANGE id_au_d id_au_d VARCHAR(15) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE id_au_f id_au_f VARCHAR(15) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
